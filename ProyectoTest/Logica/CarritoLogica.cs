...
namespace ProyectoTest.Logica
{
    public class CarritoLogica
    {
        ...
        public List<Reporte> ObtenerCompraReporte()
        {

            List<Reporte> rptListaReporte = new List<Reporte>();
            using (SqlConnection oConexion = new SqlConnection(Conexion.CN))
            {
                SqlCommand cmd = new SqlCommand("sp_ObtenerReporte", oConexion);
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        rptListaReporte.Add(new Reporte()
                        {
                    ...
                    return rptListaReporte;

                }
                catch (Exception ex)
                {
                    rptListaReporte = null;
                    return rptListaReporte;
                }
            }
        }
